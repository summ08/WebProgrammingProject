...
namespace sukaHospital.Web.Areas.Identity.Pages.Account
{
    public class DoktorRegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, WebSite_Doktor);
